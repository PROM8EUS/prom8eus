...
export const DICT: Record<Lang, Record<string, string>> = {
  de: {
    ...
    about_mission_text: "Wir bringen Klarheit in eine entscheidende Frage: Sollte eine Aufgabe von Menschen oder Maschinen erledigt werden?",
    about_what_we_do: "Was wir tun",
    about_what_we_do_text: "PROM8EUS analysiert Stellenbeschreibungen und liefert einen klaren Score, der zeigt, wie automatisierbar jede Aufgabe wirklich ist.",
    about_human_centered: "Menschenzentriert",
    about_human_centered_desc: "Geringes Automatisierungspotenzial",
    about_mixed: "Gemischt",
    about_mixed_desc: "Ausgewogenheit von beidem",
    about_high_potential: "Hohes Potenzial", 
    about_high_potential_desc: "Maschinen können das meiste übernehmen",
    about_how_it_works: "Wie es funktioniert",
    about_input: "Eingabe",
    about_input_desc: "Stellenbeschreibung hochladen oder Text einfügen",
    about_analysis: "Analyse", 
    about_analysis_desc: "KI zerlegt Aufgaben und Kategorien",
    about_scoring: "Bewertung",
    about_scoring_desc: "Jede Aufgabe erhält einen Automatisierungs-Score",
    about_results: "Ergebnisse",
    about_results_desc: "Klares Dashboard mit umsetzbaren Erkenntnissen",
    about_why_prom8eus: "Warum PROM8EUS?",
    about_transparent: "Transparent",
    about_transparent_desc: "Klare Zahlen, keine Buzzwords",
    about_actionable: "Umsetzbar",
    about_actionable_desc: "Praktische Empfehlungen",
    about_balanced: "Ausgewogen", 
    about_balanced_desc: "Menschen und Maschinen zusammen",
    about_story_quote: "Wie Prometheus das Feuer zur Menschheit brachte, liefert PROM8EUS das moderne Feuer der Automatisierung.",
    about_story_vision: "Maschine oder Mensch – was ist die richtige Wahl für jede Aufgabe?",
    about_cta_title: "Bereit für Ihren Score?",
