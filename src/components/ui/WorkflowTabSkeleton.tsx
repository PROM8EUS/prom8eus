/**
 * WorkflowTabSkeleton Component
 * Skeleton loading states for the WorkflowTab
 */
...
interface WorkflowTabSkeletonProps {
  count?: number;
  compact?: boolean;
  className?: string;
}
...
export const WorkflowTabSkeleton: React.FC<WorkflowTabSkeletonProps> = ({
  count = 6,
  compact = true,
  className
}) => {
...
export default WorkflowTabSkeleton;
